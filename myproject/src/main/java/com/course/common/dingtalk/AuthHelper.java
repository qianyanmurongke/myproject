package com.course.common.dingtalk;
...
public class AuthHelper {
	 ...
	 * @return
	 */
	public static Map<String, String> getConfig(HttpServletRequest request) {
		...
		// String configValue = "{jsticket:'" + ticket + "',signature:'" +
		// signature + "',nonceStr:'" + nonceStr + "',timeStamp:'"
		...
		configValue.put("timeStamp", Long.toString(timeStamp));
		configValue.put("corpId", Env.CORP_ID);
		configValue.put("agentid", Env.AGENT_ID);
		configValue.put("url",url);
