...
public abstract class Context {
	...
	public static MemberGroup getCurrentGroup(ServletRequest request) {
		MemberGroup group = (MemberGroup) request.getAttribute(GROUP_REQUEST_NAME);
		return group;
	}
	...
	public static Collection<MemberGroup> getCurrentGroups(ServletRequest request) {
		@SuppressWarnings("unchecked")
		Collection<MemberGroup> groups = (Collection<MemberGroup>) request.getAttribute(GROUPS_REQUEST_NAME);
		return groups;
	}

	public static void setCurrentGroups(ServletRequest request, Collection<MemberGroup> groups) {
	...
	public static Collection<Org> getCurrentOrgs(ServletRequest request) {
		@SuppressWarnings("unchecked")
		Collection<Org> orgs = (Collection<Org>) request.getAttribute(ORGS_REQUEST_NAME);
		return orgs;
	}

	public static void setCurrentOrgs(ServletRequest request, Collection<Org> orgs) {
