 ...
 * 
 */
public class ClassCardJsonFilter implements Filter {
	private static final Logger logger = LoggerFactory.getLogger(ClassCardJsonFilter.class);
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
		...
		if ("post".equals(request.getMethod().toLowerCase())) {
			...
			if (request.getHeader(Constants.CLASSCARD_AUTHORIZATION) != null) {
				response.setHeader(Constants.CLASSCARD_AUTHORIZATION,
						request.getHeader(Constants.CLASSCARD_AUTHORIZATION));
			} 
			...
			result.put("message", "接口使用非法，请使用POST请求");
