...
public class QRole extends EntityPathBase<Role> {
    ...
    public final SetPath<com.course.core.domain.UserRole, QUserRole> userRoles = this.<com.course.core.domain.UserRole, QUserRole>createSet("userRoles", com.course.core.domain.UserRole.class, QUserRole.class, PathInits.DIRECT2);
