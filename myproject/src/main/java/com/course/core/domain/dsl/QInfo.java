...
public class QInfo extends EntityPathBase<Info> {
    ...
    public final SetPath<com.course.core.domain.InfoBuffer, QInfoBuffer> buffers = this.<com.course.core.domain.InfoBuffer, QInfoBuffer>createSet("buffers", com.course.core.domain.InfoBuffer.class, QInfoBuffer.class, PathInits.DIRECT2);
    ...
    public final ListPath<com.course.core.domain.InfoFile, QInfoFile> files = this.<com.course.core.domain.InfoFile, QInfoFile>createList("files", com.course.core.domain.InfoFile.class, QInfoFile.class, PathInits.DIRECT2);

    public final StringPath htmlStatus = createString("htmlStatus");

    public final NumberPath<Integer> id = createNumber("id", Integer.class);

    public final ListPath<com.course.core.domain.InfoImage, QInfoImage> images = this.<com.course.core.domain.InfoImage, QInfoImage>createList("images", com.course.core.domain.InfoImage.class, QInfoImage.class, PathInits.DIRECT2);

    public final ListPath<com.course.core.domain.InfoAttribute, QInfoAttribute> infoAttrs = this.<com.course.core.domain.InfoAttribute, QInfoAttribute>createList("infoAttrs", com.course.core.domain.InfoAttribute.class, QInfoAttribute.class, PathInits.DIRECT2);

    public final SetPath<com.course.core.domain.InfoMemberGroup, QInfoMemberGroup> infoGroups = this.<com.course.core.domain.InfoMemberGroup, QInfoMemberGroup>createSet("infoGroups", com.course.core.domain.InfoMemberGroup.class, QInfoMemberGroup.class, PathInits.DIRECT2);

    public final ListPath<com.course.core.domain.InfoNode, QInfoNode> infoNodes = this.<com.course.core.domain.InfoNode, QInfoNode>createList("infoNodes", com.course.core.domain.InfoNode.class, QInfoNode.class, PathInits.DIRECT2);

    public final SetPath<com.course.core.domain.InfoOrg, QInfoOrg> infoOrgs = this.<com.course.core.domain.InfoOrg, QInfoOrg>createSet("infoOrgs", com.course.core.domain.InfoOrg.class, QInfoOrg.class, PathInits.DIRECT2);

    public final ListPath<com.course.core.domain.InfoTag, QInfoTag> infoTags = this.<com.course.core.domain.InfoTag, QInfoTag>createList("infoTags", com.course.core.domain.InfoTag.class, QInfoTag.class, PathInits.DIRECT2);
