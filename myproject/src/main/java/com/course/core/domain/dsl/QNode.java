...
public class QNode extends EntityPathBase<Node> {
    ...
    public final SetPath<com.course.core.domain.NodeBuffer, QNodeBuffer> buffers = this.<com.course.core.domain.NodeBuffer, QNodeBuffer>createSet("buffers", com.course.core.domain.NodeBuffer.class, QNodeBuffer.class, PathInits.DIRECT2);
    ...
    public final SetPath<com.course.core.domain.NodeDetail, QNodeDetail> details = this.<com.course.core.domain.NodeDetail, QNodeDetail>createSet("details", com.course.core.domain.NodeDetail.class, QNodeDetail.class, PathInits.DIRECT2);
    ...
    public final SetPath<com.course.core.domain.NodeMemberGroup, QNodeMemberGroup> nodeGroups = this.<com.course.core.domain.NodeMemberGroup, QNodeMemberGroup>createSet("nodeGroups", com.course.core.domain.NodeMemberGroup.class, QNodeMemberGroup.class, PathInits.DIRECT2);

    public final QModel nodeModel;

    public final SetPath<com.course.core.domain.NodeOrg, QNodeOrg> nodeOrgs = this.<com.course.core.domain.NodeOrg, QNodeOrg>createSet("nodeOrgs", com.course.core.domain.NodeOrg.class, QNodeOrg.class, PathInits.DIRECT2);

    public final SetPath<com.course.core.domain.NodeRole, QNodeRole> nodeRoles = this.<com.course.core.domain.NodeRole, QNodeRole>createSet("nodeRoles", com.course.core.domain.NodeRole.class, QNodeRole.class, PathInits.DIRECT2);
