...
import static com.course.core.constant.Constants.IDENTITY_COOKIE_NAME;
...
public class Site implements java.io.Serializable {
	 ...
	 * 获得当前模板主题的资源文件路径
	 * 
	 * 例如：/course/template/1/bluewise/_files
	 * 
	 * @return
	 */
	@Transient
	...
	@Transient
	public SiteSystemParameter getSystemParameter(){
		return new SiteSystemParameter(this);
	}
