...
import com.course.core.domain.Attachment;
...
public class QAttachment extends EntityPathBase<Attachment> {
    ...
    public final SetPath<com.course.core.domain.AttachmentRef, QAttachmentRef> refs = this.<com.course.core.domain.AttachmentRef, QAttachmentRef>createSet("refs", com.course.core.domain.AttachmentRef.class, QAttachmentRef.class, PathInits.DIRECT2);
