...
public class QOrg extends EntityPathBase<Org> {
    ...
    public final SetPath<com.course.core.domain.UserOrg, QUserOrg> userOrgs = this.<com.course.core.domain.UserOrg, QUserOrg>createSet("userOrgs", com.course.core.domain.UserOrg.class, QUserOrg.class, PathInits.DIRECT2);

    public final SetPath<com.course.core.domain.User, QUser> users = this.<com.course.core.domain.User, QUser>createSet("users", com.course.core.domain.User.class, QUser.class, PathInits.DIRECT2);
