...
public class QSite extends EntityPathBase<Site> {
    ...
    public final ListPath<com.course.core.domain.Role, QRole> roles = this.<com.course.core.domain.Role, QRole>createList("roles", com.course.core.domain.Role.class, QRole.class, PathInits.DIRECT2);
