...
public class QTag extends EntityPathBase<Tag> {
    ...
    public final SetPath<com.course.core.domain.InfoTag, QInfoTag> infoTags = this.<com.course.core.domain.InfoTag, QInfoTag>createSet("infoTags", com.course.core.domain.InfoTag.class, QInfoTag.class, PathInits.DIRECT2);
