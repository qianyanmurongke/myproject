...
public class QGlobal extends EntityPathBase<Global> {
    ...
    public final ListPath<com.course.core.domain.Site, QSite> sites = this.<com.course.core.domain.Site, QSite>createList("sites", com.course.core.domain.Site.class, QSite.class, PathInits.DIRECT2);
