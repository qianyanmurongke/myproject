...
public class QMailOutbox extends EntityPathBase<MailOutbox> {
    ...
    public final SetPath<com.course.core.domain.MailInbox, QMailInbox> inboxs = this.<com.course.core.domain.MailInbox, QMailInbox>createSet("inboxs", com.course.core.domain.MailInbox.class, QMailInbox.class, PathInits.DIRECT2);
