...
public class QModel extends EntityPathBase<Model> {
    ...
    public final ListPath<com.course.core.domain.ModelField, QModelField> fields = this.<com.course.core.domain.ModelField, QModelField>createList("fields", com.course.core.domain.ModelField.class, QModelField.class, PathInits.DIRECT2);
