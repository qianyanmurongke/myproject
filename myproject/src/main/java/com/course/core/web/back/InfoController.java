...
import com.course.core.commercial.Weixin;
import com.course.core.commercial.WordImporter;
import com.course.core.constant.Constants;
import com.course.core.domain.*;
import com.course.core.html.HtmlService;
import com.course.core.service.*;
...
public class InfoController {
	...
	@RequiresPermissions("core:info:emergencynoticelist")
	@RequestMapping("emergencynoticelist.do")
	public String emergencynoticeList(Integer queryNodeId, Integer queryNodeType, Integer queryInfoPermType, String queryStatus,
		...
		return "core/info/info_emergencynoticelist";
	}
	...
	public String save(Info bean, InfoDetail detail, Integer[] nodeIds, Integer[] specialIds, Integer[] viewGroupIds,
		...
		logService.operation("opr.info.add", bean.getTitle(), null, bean.getId(), ip, userId, siteId, userAgent);
	...
	public String auditPass(Integer[] ids, String opinion, Integer position, Integer queryNodeId, Integer queryNodeType,
			Integer queryInfoPermType, String queryStatus, String redirect, HttpServletRequest request,
	...
	public String recall(Integer[] ids, Integer queryNodeId, Integer queryNodeType, Integer queryInfoPermType,
		...
		String userAgent = request.getHeader("user-agent");
		for (Info bean : beans) {
			logService.operation("opr.info.recall", bean.getTitle(), null, bean.getId(), ip, user.getId(), site.getId(),
					userAgent);
	...
	public String delete(Integer[] ids, Integer queryNodeId, Integer queryNodeType, Integer queryInfoPermType,
		...
		String userAgent = request.getHeader("user-agent");
		for (Info bean : beans) {
			logService.operation("opr.info.delete", bean.getTitle(), null, bean.getId(), ip, user.getId(), site.getId(),
					userAgent);
	...
	public String massWeixinForm(Integer[] ids, Integer queryNodeId, Integer queryNodeType, Integer queryInfoPermType,
		...
		Site site = Context.getCurrentSite();
		validateIds(ids, site.getId());
		return Weixin.massWeixinForm(ids, queryNodeId, queryNodeType, queryInfoPermType, queryStatus, request, modelMap,
				weixinProxy, query);
	}
