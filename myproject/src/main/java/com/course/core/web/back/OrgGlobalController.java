...
public class OrgGlobalController {
	private static final Logger logger = LoggerFactory.getLogger(OrgGlobalController.class);
	...
	public String list(Integer queryParentId, @RequestParam(defaultValue = "true") boolean showDescendants,
		...
		List<Org> list = service.findList(null, queryParentId, showDescendants, params, pageable.getSort());
	...
	public String create(Integer id, Integer parentId, Integer queryParentId, Boolean showDescendants,
		...
		modelMap.addAttribute("queryParentId", queryParentId);
		modelMap.addAttribute("showDescendants", showDescendants);
		return "core/org_global/org_global_add_form";
	}
	...
	public String edit(Integer id, Integer queryParentId, @RequestParam(defaultValue = "true") boolean showDescendants,
		...
		Map<String, String[]> params = Servlets.getParamValuesMap(request, Constants.SEARCH_PREFIX);
		RowSide<Org> side = service.findSide(null, queryParentId, showDescendants, params, bean, position,
				pageable.getSort());
	...
	public String update(@ModelAttribute("bean") Org bean, Integer parentId, Integer queryParentId,
			Boolean showDescendants, Integer position, String redirect, HttpServletRequest request,
