...
import com.course.common.captcha.CaptchaServlet;
import com.course.common.image.ImageHandler;
import com.course.common.image.ImageMagickHandler;
import com.course.common.image.ImageScalrHandler;
import com.course.common.orm.MyJpaRepositoryFactoryBean;
import com.course.common.web.KeepSessionServlet;
import com.course.core.constant.Constants;
import com.course.core.support.SiteResolver;

@Configuration
@EntityScan({ "com.course.core.domain", "com.course.ext.domain" })
@EnableJpaRepositories(basePackages = { "com.course.core.repository", "com.course.ext.repository" }, repositoryFactoryBeanClass = MyJpaRepositoryFactoryBean.class)
@ComponentScan({ "com.course.core.service.impl", "com.course.ext.service.impl", "com.course.core.web.fore",
		"com.course.ext.web.fore" })
