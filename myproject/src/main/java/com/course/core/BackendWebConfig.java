...
import com.course.common.web.BindingInitializer;
import com.course.common.web.PageableArgumentResolver;
import com.course.common.web.TimerInterceptor;
import com.course.core.support.BackInterceptor;

/**
 * 后台Web配置类
 */
@Configuration
@ComponentScan({ "com.course.core.web.back", "com.course.ext.web.back" })
