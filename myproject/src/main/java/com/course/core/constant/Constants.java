...
public class Constants {
     ...
     * 存放Authorization的header字段
     */
    public static final String CLASSCARD_AUTHORIZATION = "classcard_authorization";
	 ...
	 * 手机APP访问站点前缀
	 */
	public static final String SITE_PHONE_PREFIX = "/site-phone";
	/**
	 * 上下文路径
	 */
	 ...
	 * 身份识别COOKIE名称
	 */
	public static final String IDENTITY_COOKIE_NAME = "_course";
	/**
	 * 默认分页数量
	 */
	 ...
	 * 如：file:d:\\course\\template 或 file:/home/mysite/template。
	...
	public static String CMSCP = "/admin";
	public static String BACK_SUCCESS_URL = "/admin/index.do";
	public static String BACK_LOGIN_URL = "/admin/login.do";
