		...
		Plugin.prototype = {
			...
			stop: function() {
				...
				$(".weixinAudio").each(function() {
					var self = this;
					self.$Audio = $(this).children('#media');
					self.Audio = this.$Audio[0];
					self.Audio.pause();
					self.currentState = "pause";
					self.$audio_area = $(this).find('#audio_area');
					self.$audio_length = $(this).find('#audio_length');
					self.$audio_area.removeClass('playing');
				});
			...
			animateProgressBarPosition: function() {
				if(this.$audio_progress == undefined) {
					return;
				}
				var self = this,
