							...
							<tbody>
								<c:forEach var="bean" varStatus="status" items="${list}">
									<tr beanid="${bean.id}">
										...
										<td align="center">
											<f:text class="form-control input-sm" name="name" value="${bean.name}" style="width:150px;" />
										</td>
										<td align="center">
											<f:text class="form-control input-sm" name="number" value="${bean.number}" style="width:150px;" />
										</td>
