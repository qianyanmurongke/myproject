				...
				<form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
					...
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<f:text name="organizationNumber" class="form-control" maxlength="150" value="${bean.organizationNumber }" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<f:text name="legalRepresentative" value="${bean.legalRepresentative }" class="form-control" maxlength="150" />
									</div>
								</div>
							</div>
							<div class="col-sm-6">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.corporateidentity" /></label>
									<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.corporatenumber" /></label>
									<div class="col-sm-8">
										<f:text name="legalNumber" value="${bean.legalNumber }" class="form-control" maxlength="150" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.schoolmanage" /></label>
									<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.companymanage" /></label>
									<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.type" /></label>
									<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"><s:message code="org.district" /></label>
									<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">城乡类型码</label>
									<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">经济属性码</label>
									<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">主教学语言码</label>
									<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">辅教学语言码</label>
									<div class="col-sm-8">
