...
<html>
	...
	<body class="skin-blue content-body">
		...
		<div class="content-header">
			<h1>紧急通知 - <s:message code="list"/> <small>(<s:message code="totalElements" arguments="${pagedList.totalElements}"/>)</small></h1>
		</div>
		<div class="content">
			<div class="box box-primary">
				<div class="box-body table-responsive">
					<form id="searchForm" action="emergencynoticelist.do" method="get" class="form-inline ls-search">
					...
					<form method="post">
						...
						<table id="pagedTable" class="table table-condensed table-bordered table-hover ls-tb">
							<thead id="sortHead" pagesort="<c:out value='${page_sort[0]}' />" pagedir="${page_sort_dir[0]}" pageurl="emergencynoticelist.do?page_sort={0}&page_sort_dir={1}&queryNodeId=${queryNodeId}&queryNodeType=${queryNodeType}&queryInfoPermType=${queryInfoPermType}&queryStatus=${queryStatus}&${searchstringnosort}">
								<tr class="ls_table_th">
									...
									<th class="ls-th-sort"><span class="ls-sort" pagesort="priority">是否置顶</th>
					...
					<form action="emergencynoticelist.do" method="get" class="ls-page">
