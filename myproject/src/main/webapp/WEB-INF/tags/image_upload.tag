<%@ tag pageEncoding="UTF-8"%><%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%><%@ taglib prefix="s" uri="http://www.springframework.org/tags" %><%@ taglib prefix="f" uri="http://www.course.com/tags/form"%>
...
<div style="display:table;width:100%;">
	<div style="display:table-cell;vertical-align:middle;">
		...
		<div class="form-inline" style="margin-top:3px;">
			...
			<span style="color:red;">*请上传小于10mb的jpg/png/gif图片：建议尺寸为210*140</span>
		</div>
